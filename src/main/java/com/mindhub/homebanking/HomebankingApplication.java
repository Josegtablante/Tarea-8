...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(ClientRepository clienteRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository) {
        return (args) -> {
            ...
            //TRANSACCTION
            Transaction transaccion1 = new Transaction(DEBIT, -2500.0, "internet", LocalDateTime.now(), account1);
            transactionRepository.save(transaccion1);
            Transaction transaccion4 = new Transaction(CREDIT, 45000.0, "consola de videojuego", LocalDateTime.of(2022, 04, 8, 04, 02, 45), account1);
            transactionRepository.save(transaccion4);

            Transaction transaccion2 = new Transaction(CREDIT, 1500.0, "Compra de Supermercado", LocalDateTime.now(), account2);
            transactionRepository.save(transaccion2);

            Transaction transaccion3 = new Transaction(CREDIT, 5500.0, "Zapatos", LocalDateTime.now().minusHours(54), account2);
            ...
            Loan prestamo3 = new Loan("Automotriz", 300000.0, cuotas3);//6,12,24,36
